...
if [[ ! -z $(kubectl get namespace | grep "^monitoring" ) ]]; then
  ...
  kubectl delete configmap ${APP}-dashboard-configmap -n monitoring
  kubectl delete configmap ingress-nginx-dashboard -n monitoring
  kubectl delete configmap ingress-nginx-perf-dashboard -n monitoring
  kubectl delete configmap fluentbit-dashboard -n monitoring
  kubectl delete configmap influxdb-dashboard -n monitoring
